...
public class UpdateData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("user")!=null&&request.getParameter("user").equals(Data.user)&&request.getParameter("pass")!=null&&request.getParameter("pass").equals(Data.pass)
			...
			if(request.getParameter("Type").trim().equals(Data.Humidity)){
				try {
			...
			}else if(request.getParameter("Type").trim().equals(Data.Temperature)){
				try {
			...
			}else if (request.getParameter("Type").trim().equals(Data.appliance)){
				Integer KWH = degree;
				Integer tempid;
